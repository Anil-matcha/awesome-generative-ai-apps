...
| [Persona](https://github.com/jayamitkatariya/personacli) | Local-first personal workspace: notes, tasks, and grounded AI chat in plain Markdown. Runs on Ollama or any OpenAI-compatible API. | Notion ($10/mo), Mem.ai ($15/mo) | ⭐ 8 |
